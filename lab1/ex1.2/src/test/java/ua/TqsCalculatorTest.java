...
class TqsCalculatorTest {
    ...
    @DisplayName("exp and things")
    @org.junit.jupiter.api.Test
    void exp() {
        TqsCalculator t = new TqsCalculator();
        assertEquals(2, t.exp(2, 1));
        assertEquals(8, t.exp(2, 3));
        assertEquals(1, t.exp(2, 0));
    }

    @DisplayName("sqareroot and things")
    @org.junit.jupiter.api.Test
    void sqroot() {
        TqsCalculator t = new TqsCalculator();
        assertEquals(2, t.sqroot(4));
        assertThrows(IllegalArgumentException.class, () -> t.sqroot(-2));
    }
}